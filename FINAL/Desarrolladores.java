...
class Desarrolladores
 extends JFrame{
    ...
    private JLabel actividades=new JLabel("Desarrolladores");
 	private Usuario datos;   
    //CONSTRUCTOR
    public Desarrolladores(Usuario datos){
        ...
        content.add(new ScrolledPaneDesarrolladores());
 ...
 class ScrolledPaneDesarrolladores extends JPanel
{
    private JScrollPane vertical;
    private JTextArea console;

    public ScrolledPaneDesarrolladores()
    {
