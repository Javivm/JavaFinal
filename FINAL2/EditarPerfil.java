...
public class MainEditar{
public MainEditar(Usuario datos){
    Editar window = new Editar(Usuario datos);
...
class Editar extends JFrame{//implementando el listener de eventos
    ...
    Editar(Usuario datos){
        ...
        JTextArea edadE = new JTextArea();//+datos.getFecha());
        JTextArea pesoE = new JTextArea();//+datos.getPeso());
        JTextArea alturaE = new JTextArea();//+datos.getAltura());
        JTextArea nicknameE = new JTextArea();//+datos.getNickname());
        JTextArea emailE = new JTextArea();//+datos.getCorreo());
        
        JLabel vacio=new JLabel("Perfil");
        JButton regresar = new JButton("Guardar");
